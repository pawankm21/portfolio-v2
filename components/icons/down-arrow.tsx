...
export default function DownArrow({className}:IconProps) {
	return (


		<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="auto" height="auto"
			viewBox="0 0 490.4 490.4" className={className} preserveAspectRatio="xMidYMid meet">
